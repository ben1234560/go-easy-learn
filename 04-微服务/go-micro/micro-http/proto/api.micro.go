...
type FooService interface {
	Emp(ctx context.Context, in *EmptyRequest, opts ...client.CallOption) (*EmptyResponse, error)
}
...
func (c *fooService) Emp(ctx context.Context, in *EmptyRequest, opts ...client.CallOption) (*EmptyResponse, error) {
	req := c.c.NewRequest(c.name, "Foo.Emp", in)
...
type FooHandler interface {
	Emp(context.Context, *EmptyRequest, *EmptyResponse) error
}

func RegisterFooHandler(s server.Server, hdlr FooHandler, opts ...server.HandlerOption) error {
	type foo interface {
		Emp(ctx context.Context, in *EmptyRequest, out *EmptyResponse) error
	}
	type Foo struct {
		foo
	}
...
func (h *fooHandler) Emp(ctx context.Context, in *EmptyRequest, out *EmptyResponse) error {
	return h.FooHandler.Emp(ctx, in, out)
}
