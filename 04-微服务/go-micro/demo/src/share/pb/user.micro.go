...
type UserService interface {
	...
	DeleteUser(ctx context.Context, in *DeleteUserReq, opts ...client.CallOption) (*DeleteUserRep, error)
...
func (c *userService) DeleteUser(ctx context.Context, in *DeleteUserReq, opts ...client.CallOption) (*DeleteUserRep, error) {
...
type UserServiceHandler interface {
	...
	DeleteUser(context.Context, *DeleteUserReq, *DeleteUserRep) error
...
func RegisterUserServiceHandler(s server.Server, hdlr UserServiceHandler, opts ...server.HandlerOption) error {
	type userService interface {
		...
		DeleteUser(ctx context.Context, in *DeleteUserReq, out *DeleteUserRep) error
...
func (h *userServiceHandler) DeleteUser(ctx context.Context, in *DeleteUserReq, out *DeleteUserRep) error {
